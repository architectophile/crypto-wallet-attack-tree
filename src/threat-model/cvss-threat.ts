...
export const TH_SHOULDER_SURFING: number[] = [AV.P, AC.M, PR.N, UI.R, TC.L, EX.L, EQ.S];
export const TH_EVIL_MAID: number[] = [AV.P, AC.H, PR.N, UI.N, TC.M, EX.E, EQ.S];
export const TH_FAKE_BIOMETRICS: number[] = [AV.P, AC.H, PR.N, UI.N, TC.L, EX.P, EQ.P];
...
export const TH_PHYSICAL_ATTACK: number[] = [AV.P, AC.H, PR.N, UI.N, TC.H, EX.E, EQ.P];
export const TH_CONNECT_DEBUGGER: number[] = [AV.P, AC.M, PR.N, UI.N, TC.H, EX.P, EQ.S];
export const TH_ROWHAMMER: number[] = [AV.P, AC.H, PR.N, UI.N, TC.H, EX.E, EQ.P];
export const TH_COLD_BOOT: number[] = [AV.P, AC.H, PR.N, UI.N, TC.H, EX.E, EQ.P];
...
export const TH_ROUGE_AP: number[] = [AV.L, AC.M, PR.N, UI.N, TC.L, EX.P, EQ.P];
export const TH_REMOVABLE_MEDIA: number[] = [AV.P, AC.L, PR.N, UI.N, TC.M, EX.L, EQ.S];
export const TH_EXECUTE_KEY_LOGGING: number[] = [AV.N, AC.L, PR.L, UI.R, TC.L, EX.L, EQ.S];
export const TH_EXECUTE_SCREEN_RECORDING: number[] = [AV.N, AC.L, PR.L, UI.R, TC.L, EX.L, EQ.S];
export const TH_EXECUTE_CLIPBOARD_HIJACKING: number[] = [AV.N, AC.L, PR.N, UI.R, TC.L, EX.L, EQ.S];
export const TH_EXECUTE_RANSOMWARE: number[] = [AV.N, AC.L, PR.L, UI.N, TC.L, EX.P, EQ.S];
export const TH_EXECUTE_NETWORK_PACKET_SNIFFING: number[] = [AV.N, AC.L, PR.N, UI.R, TC.L, EX.L, EQ.S];
export const TH_EXECUTE_USB_PACKET_SNIFFING: number[] = [AV.N, AC.L, PR.L, UI.R, TC.L, EX.P, EQ.S];
...
export const TH_ACCESS_PHYSICALLY: number[] = [AV.P, AC.H, PR.N, UI.N, TC.L, EX.L, EQ.S];
export const TH_TRY_INVALID_PIN: number[] = [AV.P, AC.L, PR.N, UI.N, TC.L, EX.L, EQ.S];
