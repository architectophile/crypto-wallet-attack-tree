...
import { addBNInfo, generateAttackTree } from "./threat-model/node-data";
...
const network: INetwork = {
  ...
  'T336': {cpt: [], id: 'T336', states: ['T', 'F'], parents: []},
  'T337': {cpt: [], id: 'T337', states: ['T', 'F'], parents: []},
  'T338': {cpt: [], id: 'T338', states: ['T', 'F'], parents: []},
  'T339': {cpt: [], id: 'T339', states: ['T', 'F'], parents: []},
  'T340': {cpt: [], id: 'T340', states: ['T', 'F'], parents: []},
};

const g1BNLedger: RawNodeDatum = addBNInfo(g1TreeLedger, network);
...
const networkTest: INetwork = {
  ...
  'B131': {
    cpt:[
      {when:{T336: 'T', T337: 'T', T338: 'T', T339: 'T'}, then:{T: 1, F: 0}},      
      {when:{T336: 'F', T337: 'T', T338: 'T', T339: 'T'}, then:{T: 1, F: 0}},
      {when:{T336: 'T', T337: 'F', T338: 'T', T339: 'T'}, then:{T: 1, F: 0}},
      {when:{T336: 'F', T337: 'F', T338: 'T', T339: 'T'}, then:{T: 1, F: 0}},
      {when:{T336: 'T', T337: 'T', T338: 'F', T339: 'T'}, then:{T: 1, F: 0}},
      {when:{T336: 'F', T337: 'T', T338: 'F', T339: 'T'}, then:{T: 1, F: 0}},
      {when:{T336: 'T', T337: 'F', T338: 'F', T339: 'T'}, then:{T: 1, F: 0}},
      {when:{T336: 'F', T337: 'F', T338: 'F', T339: 'T'}, then:{T: 1, F: 0}},
      {when:{T336: 'T', T337: 'T', T338: 'T', T339: 'F'}, then:{T: 1, F: 0}},
      {when:{T336: 'F', T337: 'T', T338: 'T', T339: 'F'}, then:{T: 1, F: 0}},
      {when:{T336: 'T', T337: 'F', T338: 'T', T339: 'F'}, then:{T: 1, F: 0}},
      {when:{T336: 'F', T337: 'F', T338: 'T', T339: 'F'}, then:{T: 1, F: 0}},
      {when:{T336: 'T', T337: 'T', T338: 'F', T339: 'F'}, then:{T: 1, F: 0}},
      {when:{T336: 'F', T337: 'T', T338: 'F', T339: 'F'}, then:{T: 1, F: 0}},
      {when:{T336: 'T', T337: 'F', T338: 'F', T339: 'F'}, then:{T: 1, F: 0}},
      {when:{T336: 'F', T337: 'F', T338: 'F', T339: 'F'}, then:{T: 0, F: 1}},
    ],
    id: 'B131', 
    states: ['T', 'F'], 
    parents:['T336', 'T337', 'T338', 'T339']
  ...
  'T336': {cpt: {T: 0.3, F: 0.7}, id: 'T336', states: ['T', 'F'], parents: []},
  'T337': {cpt: {T: 0.27, F: 0.73}, id: 'T337', states: ['T', 'F'], parents: []},
  'T338': {cpt: {T: 0.18, F: 0.82}, id: 'T338', states: ['T', 'F'], parents: []},
  'T339': {cpt: {T: 0.13, F: 0.87}, id: 'T339', states: ['T', 'F'], parents: []},
  'T340': {cpt: {T: 0.53, F: 0.47}, id: 'T340', states: ['T', 'F'], parents: []},
};
